...
//    Search elements
    public static final String phoneCaseIphone11WebElement = "//h3[contains(text(),'iphone 13 case, Pressed Dried Flower Handmade iPho')]";
    public static final String verifyPhoneCaseIphone11WebElement = "//h1[contains(text(),'iphone 13 case, Pressed Dried Flower Handmade iPho')]";
